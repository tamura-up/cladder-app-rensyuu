...
class RegisterUserSerializer(serializers.Serializer):
    ...
    last_name = serializers.CharField(max_length=150, required=False, write_only=True, default="")
    first_name = serializers.CharField(max_length=150, required=False, write_only=True, default="")
